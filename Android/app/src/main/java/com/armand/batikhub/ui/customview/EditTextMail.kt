package com.armand.batikhub.ui.customview
...
import com.armand.batikhub.utils.Constanta
...
class EditTextEmail : AppCompatEditText {
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        context.apply {
            ...
            setTextColor(ContextCompat.getColor(this, R.color.slate_500))
            setHintTextColor(ContextCompat.getColor(this, R.color.slate_500))
        }
        isSingleLine = true

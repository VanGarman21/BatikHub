...
public final class FragmentHomeBinding implements ViewBinding {
  ...
  private FragmentHomeBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView btnInfo,
      @NonNull ImageView btnSearch, @NonNull TextInputEditText etQuery,
      @NonNull FrameLayout frameLayout, @NonNull RecyclerView recyclerView) {
  ...
  public static FragmentHomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentHomeBinding((ConstraintLayout) rootView, btnInfo, btnSearch, etQuery,
